...
RULES = [
    ...
    ("operacion", "INVALID_OPERATION", "INTERNAL_CORRECTABLE", "NORMALIZATION", "high", "operacion IS NOT NULL AND btrim(operacion) <> '' AND lower(btrim(operacion)) NOT IN ('venta','alquiler','alquiler_temporario','alquiler temporario','venta_y_alquiler','permuta','emprendimiento','consultar','desconocida','otra','otro')", "unsupported operation"),
