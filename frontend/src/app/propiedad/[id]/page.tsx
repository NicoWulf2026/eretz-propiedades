      ...
      <div className="container py-8">
        ...
        <div className="mt-8 grid gap-8 lg:grid-cols-[minmax(0,1.6fr)_minmax(320px,.7fr)]">
          <div className="min-w-0 space-y-8">
            ...
            <section className="detail-panel"><h2>Ubicación</h2><p className="mt-3 text-slate-600">{property.address ? `${property.address}, ` : ""}{propertyLocation(property)}</p><div className="mt-5 h-[420px] overflow-hidden rounded-2xl"><PropertyMap properties={[property]} filters={parsePropertyFilters({})} label="Ubicación de la propiedad" returnTo={returnTo} /></div></section>
          </div>
