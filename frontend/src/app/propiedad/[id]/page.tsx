      ...
      <div className="container py-8">
        ...
        <div className="mt-8 grid gap-8 lg:grid-cols-[minmax(0,1.6fr)_minmax(320px,.7fr)]">
          ...
          <a href="#aviso">Información del aviso</a>
            ...
            <section id="ubicacion" className="detail-panel scroll-mt-24"><h2>Ubicación</h2><p className="mt-3 u-text-muted">{property.address ? `${property.address}, ` : ""}{propertyLocation(property)}</p><div className="mt-5 h-[420px] overflow-hidden rounded-2xl"><PropertyMap properties={[property]} filters={parsePropertyFilters({})} label="Ubicación de la propiedad" returnTo={returnTo} /></div></section>
