  ...
  return (
    <footer className="site-footer mt-auto border-t">
      <div className="container grid gap-10 py-12 md:grid-cols-[1.4fr_1fr_1fr]">
        <div>
          <Brand dark />
          <p className="mt-5 max-w-md text-sm leading-6 footer-lede">
        ...
        <nav aria-label="Explorar" className="flex flex-col gap-2 text-sm">
          <p className="mb-2 font-bold footer-heading">Explorar</p>
        ...
        <nav aria-label="Información legal" className="flex flex-col gap-2 text-sm">
          <p className="mb-2 font-bold footer-heading">Información</p>
      ...
      <div className="footer-rule">
        <div className="container py-5 text-xs leading-5 footer-fineprint">
