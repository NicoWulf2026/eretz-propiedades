...
| ACL PostGIS | PARTIAL | N/A | N/A | Grants P0 directos | anon/auth afectados | N/A | Remediation revisada, no ejecutada | P0 | S | SQL, rollback y verificador de sólo lectura listos. Requiere autorización explícita y canary remoto. |
